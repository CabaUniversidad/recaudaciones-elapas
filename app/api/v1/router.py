...
from app.api.v1.endpoints import (
    ...
    pagos, cortes, empleados, auth, configuracion
)
...
api_router.include_router(lecturas.router, prefix='/lecturas', tags=['Lecturas'],dependencies=[Depends(get_current_empleado)])
